...
@Slf4j
@RestController
@Tag(name = "用户登录相关接口", description ="用户登录相关接口")
...
public class LoginController {
    ...
    @Operation(summary = "获得用户信息接口", description = "获得用户信息接口")
    ...
    @Operation(summary = "通知信息接口", description = "通知信息接口")
    @GetMapping("/notices")
    ...
    @Operation(summary = "分析汇总信息接口", description = "分析汇总信息接口")
